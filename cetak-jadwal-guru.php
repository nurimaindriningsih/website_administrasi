                        ...
                        <div class="col-4">
                            <select id="nip" name="nip" class="custom-select">
                                <option value="1234567890112343"
                                    <?= $nip == '1234567890112343' ? ' selected="selected"' : ''; ?>>Diena Fitri Hanifah
                                </option>
                                <option value="1234567890112344"
                                    <?= $nip == '1234567890112344' ? ' selected="selected"' : ''; ?>>Elsa Adhistiawati
                                </option>
                                <option value="1963122419123452"
                                    <?= $nip == '1963122419123452' ? ' selected="selected"' : ''; ?>>Muhammad Arif Gunawan
                                </option>
                                <option value="1963122419890030"
                                    <?= $nip == '1963122419890030' ? ' selected="selected"' : ''; ?>>Windy
                                </option>
                                <option value="1963122419899008"
                                    <?= $nip == '1963122419899008' ? ' selected="selected"' : ''; ?>>Abdullah
                                </option>
                                <option value="1963122419899022"
                                    <?= $nip == '1963122419899022' ? ' selected="selected"' : ''; ?>>Sri Hastuti
                                </option>
                                <option value="1963122419899065"
                                    <?= $nip == '1963122419899065' ? ' selected="selected"' : ''; ?>>Maulana Yasin
                                </option>
                                <option value="1963122419899999"
                                    <?= $nip == '1963122419899999' ? ' selected="selected"' : ''; ?>>Masayu Nina
                                </option>
                                <option value="1983122419899111"
                                    <?= $nip == '1983122419899111' ? ' selected="selected"' : ''; ?>>Memi
                                </option>
                                <option value="1993122419899990"
                                    <?= $nip == '1993122419899990' ? ' selected="selected"' : ''; ?>>Husen Nadawi
                                </option>
                            </select>
                        </div>
                        <div class="buttons">
