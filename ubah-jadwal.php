            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <select id="kd_mapel" name="kd_mapel" class="custom-select">
                        ...
                        <option value="1001"
                            <?= $jadwal_pelajaran['kd_mapel'] == '1001' ? ' selected="selected"' : ''; ?>>Pkn
                        </option>
                        <option value="1002"
                            <?= $jadwal_pelajaran['kd_mapel'] == '1002' ? ' selected="selected"' : ''; ?>>Bahasa Inggris
                        </option>
                        <option value="1003"
                            <?= $jadwal_pelajaran['kd_mapel'] == '1003' ? ' selected="selected"' : ''; ?>>Ipa
                        </option>
                        <option value="1004"
                            <?= $jadwal_pelajaran['kd_mapel'] == '1004' ? ' selected="selected"' : ''; ?>>Bahasa
                            Indonesia</option>
                        <option value="1005"
                            <?= $jadwal_pelajaran['kd_mapel'] == '1005' ? ' selected="selected"' : ''; ?>>Ips</option>
                        <option value="1006"
                            <?= $jadwal_pelajaran['kd_mapel'] == '1006' ? ' selected="selected"' : ''; ?>>Auvi
                        </option>
                        <option value="1007"
                            <?= $jadwal_pelajaran['kd_mapel'] == '1007' ? ' selected="selected"' : ''; ?>>Gim
                        </option>
                        <option value="1008"
                            <?= $jadwal_pelajaran['kd_mapel'] == '1008' ? ' selected="selected"' : ''; ?>>Sejarah
                        </option>
                        <option value="1009"
                            <?= $jadwal_pelajaran['kd_mapel'] == '1009' ? ' selected="selected"' : ''; ?>>bahasa Jepang
                        </option>
                    </select>
                </div>
            </div>
