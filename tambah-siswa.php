            ...
            <div class="form-group row">
                ...
                <div class="col-8">
                    <select id="kd_kelas" name="kd_kelas" class="custom-select">
                        <option value="B100">10 PPLG</option>
                        <option value="B110">11 PPLG</option>
                        <option value="B120">12 PPLG</option>
                        <option value="M100">10 OTKP</option>
                        <option value="M110">11 OTKP</option>
                        <option value="M120">12 OTKP</option>
                        <option value="S100">10 TBSM</option>
                        <option value="S110">11 TBSM</option>
                        <option value="S120">12 TBSM</option>
                    </select>
                </div>
            </div>
            <div class="form-group row">
