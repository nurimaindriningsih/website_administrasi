                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            <select id="kd_kelas" name="kd_kelas" class="custom-select">
                                <option value="B100" <?= $kd_kelas == 'B100' ? ' selected="selected"' : ''; ?>>10 PPLG
                                </option>
                                <option value="B110" <?= $kd_kelas == 'B110' ? ' selected="selected"' : ''; ?>>11 PPLG
                                </option>
                                <option value="B120" <?= $kd_kelas == 'B120' ? ' selected="selected"' : ''; ?>>12 PPLG
                                </option>
                                <option value="M100" <?= $kd_kelas == 'M100' ? ' selected="selected"' : ''; ?>>10 OTKP
                                </option>
                                <option value="M110" <?= $kd_kelas == 'M110' ? ' selected="selected"' : ''; ?>>11 OTKP
                                </option>
                                <option value="M120" <?= $kd_kelas == 'M120' ? ' selected="selected"' : ''; ?>>12 OTKP
                                </option>
                                <option value="S100" <?= $kd_kelas == 'S100' ? ' selected="selected"' : ''; ?>>10 TBSM
                                </option>
                                <option value="S110" <?= $kd_kelas == 'S110' ? ' selected="selected"' : ''; ?>>11 TBSM
                                </option>
                                <option value="S120" <?= $kd_kelas == 'S120' ? ' selected="selected"' : ''; ?>>12 TBSM
                                </option>
                            </select>
                        </div>
                        <div class="buttons">
