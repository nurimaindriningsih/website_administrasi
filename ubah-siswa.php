                ...
                <div class="col-8">
                    <select id="kd_kelas" name="kd_kelas" class="custom-select">
                        ...
                        <option value="B120" <?= $siswa['kd_kelas'] == 'B120' ? ' selected="selected"' : ''; ?>>12
                            PPLG</option>
                        <option value="M100" <?= $siswa['kd_kelas'] == 'M100' ? ' selected="selected"' : ''; ?>>10 OTKP
                        </option>
                        <option value="M110" <?= $siswa['kd_kelas'] == 'M110' ? ' selected="selected"' : ''; ?>>11 OTKP
                        </option>
                        <option value="M120" <?= $siswa['kd_kelas'] == 'M120' ? ' selected="selected"' : ''; ?>>12 OTKP
                        </option>
